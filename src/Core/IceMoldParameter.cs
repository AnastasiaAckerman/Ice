namespace Core
{
    ...
    public class IceMoldParameter
    {
        ...
        public IceMoldParameter(IceMoldParameterType name, int max, int min)
        {
            Name = name;
            Min = min;
            Max = max;
