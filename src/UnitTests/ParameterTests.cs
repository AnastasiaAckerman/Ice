...
namespace UnitTests
{
    ...
    public class ParameterTests
    {
        ...
        /// </summary>
        private IceMoldParameter _testParameter
            = new IceMoldParameter(0, 100, 0);

        [Test(Description = "Позитивный тест на сеттер имени параметра")]
        public void TestParameterNameSet()
        {
            IceMoldParameterType newName = IceMoldParameterType.IceMoldDeep;
        ...
        {
            IceMoldParameterType newName = IceMoldParameterType.IceMoldWidth;
            _testParameter.Name = newName;
